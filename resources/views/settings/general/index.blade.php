...
<div class="page-wrapper">
    <div class="page-content-tab">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-4"  href="{{ route('leave-setting') }}">
                    <div class="card profile-card">
                        <div class="card-body p-0">
                            <div class="media p-3  align-items-center">                                                
                                <img src="{!! asset('backend/assets/images/widgets/project3.jpg') !!}" alt="user" class="rounded-circle thumb-xl">                                        
                                <div class="media-body ml-3 align-self-center">
                                    <h5 class="pro-title">Leave settings</h5>
                                    <p class="mb-2 text-muted">General staff leve settings</p> 
                                </div>
                            </div>                                    
                        </div>               
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="card profile-card">
                        <div class="card-body p-0">
                            <div class="media p-3  align-items-center">                                                
                                <img src="{!! asset('backend/assets/images/widgets/project1.jpg') !!}" alt="user" class="rounded-circle thumb-xl">                                        
                                <div class="media-body ml-3 align-self-center">
